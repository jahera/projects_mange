...
Apartment.configure do |config|
  ...
  #
  # config.excluded_models = %w{ User UserRole }
  ...
  config.excluded_models = %w{ User UserRole Tenant} # Add any models you want to exclude from tenant separation
  config.tenant_names = lambda { Tenant.pluck(:name) } # Provide a method to get the list of tenant names
  config.use_schemas = true


 # Use elevator to switch tenants based on a custom logic (e.g., current_user's tenant)
  Rails.application.config.middleware.use Apartment::Elevators::Generic, lambda { |request|
    # Logic to determine tenant, e.g., from session or current_user
  ...
  # Use Sidekiq with Apartment
  # require 'apartment/sidekiq'
  # Apartment::Sidekiq.configure do |config|
  #   config.excluded_workers = [] # List any workers that should not use multi-tenancy
  # end
